...
public class CurrencyConverterTest {
    ...
    public void testEURtoUSD() throws Exception {
        ...
        Amount expectedResult = new Amount(new BigDecimal("150.00"), Currency.USD);
    ...
    public void testBadCurrency() throws Exception {
        Amount fromAmount = new Amount(new BigDecimal("100.00"), Currency.USD);
        converter.getConvertedAmount(fromAmount, Currency.JPY); // unsupported currency
    }
}
